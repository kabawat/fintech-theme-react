...
import logo from '~/public/images/logo-fintech.svg';
                  ...
                  <div>
                    ...
                    <ul>
                      {footer.description.map((item, index) => (
                        <li key={item}>
                          <Link href={footer.link[index]} variant="subtitle1" underline="hover">
                            {item}
                          </Link>
                        </li>
                      ))}
